...
public class BaseTest {
	...
	@BeforeMethod
	public static void setUpBeforeTestMethod() {
	...
	protected static void login() throws InterruptedException {
		...
		waitforVisibilty(usernameTb, driver, 10, "userName Text Box");

		usernameTb.sendKeys("Sahana@tek.com");

		WebElement passwordTb = driver.findElement(By.xpath("//input[@id='password']"));
		waitforVisibilty(passwordTb, driver, 10, "userName Text Box");

		passwordTb.sendKeys("Siri@123");

		WebElement loginEle = driver.findElement(By.xpath("//input[@id='Login']"));
		loginEle.click();

//		Thread.sleep(3000);
//		String expectedTitle = "https://tekarch95-dev-ed.develop.my.salesforce.com/setup/forcecomHomepage.apexp?setupid=ForceCom";
